...
tasks.named<Jar>("jar") {
    archiveBaseName.set("roux-reactor")
}
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "roux-reactor"

            pom {
                name.set("Roux Reactor")
                description.set("Project Reactor (Mono/Flux) integration for the Roux effect system")
...
tasks.register<Zip>("createCentralBundle") {
    ...
    archiveFileName.set("roux-reactor-${version}-bundle.zip")
