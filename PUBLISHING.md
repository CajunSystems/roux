...
This creates a zip file at `lib/build/distributions/roux-0.3.0-bundle.zip` containing:
- Proper Maven directory structure (`com/cajunsystems/roux/0.3.0/`)
- `roux-0.3.0.jar` - Main library
- `roux-0.3.0-sources.jar` - Source code
- `roux-0.3.0-javadoc.jar` - Javadoc
- `roux-0.3.0.pom` - POM file
- `roux-0.3.0.module` - Gradle metadata
...
5. Upload the bundle zip file: `lib/build/distributions/roux-0.3.0-bundle.zip`
